...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			long timeStart = 0;
			long timeEnd = 0;
			String testString = DocumentBenchmarking.getStringFromFile(textfile, numToCheck);
			...
			double timeBD = (timeEnd-timeStart)/1000000000.0;
			...
			timeEnd = System.nanoTime();
			double timeED = (timeEnd-timeStart)/1000000000.0;
			System.out.println(numToCheck+" \t "+timeBD+" \t "+timeED+" \n");
